...
public class TransformTwo extends com.android.build.api.transform.Transform {
    ...
    public TransformTwo(Project project, WBLivePluginExension pluginExension) {
    ...
    void transform(Context context, Collection<TransformInput> inputs, Collection<TransformInput> referencedInputs, TransformOutputProvider outputProvider, boolean isIncremental) throws IOException, TransformException, InterruptedException {
        ...
        inputs.each { TransformInput input ->
            ...
            input.jarInputs.each { JarInput jarInput ->
                ...
                mAutoInject.addClassPath(jarInput.file.getAbsolutePath());
                //生成输出路径
